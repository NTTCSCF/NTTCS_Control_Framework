"""
Django settings for NTTCS_CF_project project.
...
SECRET_KEY = 'django-insecure-_#mol=4r8i2eq_!c=^5i8l=i+k4d)hh0swp-ba13upg@64b27x'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                    'filter': 'homepage.templatetags.filter',
                },
        },
    },
]
